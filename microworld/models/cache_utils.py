...
def get_teacache_coefficients(model_name):
    if "wan2.1-t2v-1.3b" in model_name.lower() or "wan2.1-fun-1.3b" in model_name.lower() or "wan2.1-fun-v1.1-1.3b" in model_name.lower() \
        or "skyreelv2-df-1.3b" in model_name.lower() or "wan2.1-vace-1.3b" in model_name.lower():
    ...
    elif "wan2.1-i2v-14b-720p" in model_name.lower() or "wan2.1-fun-14b" in model_name.lower() or "wan2.1-fun-v1.1-14b" in model_name.lower() or \
        "wan2.2-ti2v-5b" in model_name.lower():
